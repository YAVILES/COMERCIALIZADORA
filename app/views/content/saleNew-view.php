                ...
                <table class="table is-bordered is-striped is-narrow is-hoverable is-fullwidth">
                    ...
                    <tbody>
                        <?php
                            ...
                            if(!isset($_SESSION['venta_forma_pago'])){
                                $_SESSION['venta_forma_pago']="Bs";
                        ...
                        <tr class="has-text-centered" >
                            ...
                            <td><?php echo MONEDA_SIMBOLO.number_format($productos['venta_detalle_precio_venta'],MONEDA_DECIMALES,MONEDA_SEPARADOR_DECIMAL,MONEDA_SEPARADOR_MILLAR)." ".$_SESSION['venta_forma_pago']; ?></td>
                            <td><?php echo MONEDA_SIMBOLO.number_format($productos['venta_detalle_total'],MONEDA_DECIMALES,MONEDA_SEPARADOR_DECIMAL,MONEDA_SEPARADOR_MILLAR)." ".$_SESSION['venta_forma_pago']; ?></td>
                            <td>
                        ...
                        <?php
                                $cc++;
                                $_SESSION['venta_subtotal']+=$productos['venta_detalle_total'];
                                $iva = ($check_empresa['iva'] * $productos['venta_detalle_total']) / 100;
                                $_SESSION['venta_iva']+= $iva;
                                $_SESSION['venta_total']+=$productos['venta_detalle_total'] + $iva;
                            }
                        ?>
                        <tr class="has-text-centered" >
                            <td colspan="4"></td>
            ...
            <?php } ?>
                ...
                <div class="select mb-5">
                    <select name="venta_caja">
                        <?php
                            $datos_cajas=$insLogin->seleccionarDatos("Normal","caja","*",0,true);
                ...
                <div class="select mb-5">
                    <select name="venta_forma_pago" value="<?php echo $_SESSION['venta_forma_pago']; ?>" onchange="cambiarForma()">
                        <?php if($_SESSION['venta_forma_pago'] == 'Bs'){ ?>
                ...
                <h4 class="subtitle is-5 has-text-centered has-text-weight-bold mb-5"><small>SUBTOTAL: <?php echo MONEDA_SIMBOLO.number_format($_SESSION['venta_subtotal'],MONEDA_DECIMALES,MONEDA_SEPARADOR_DECIMAL,MONEDA_SEPARADOR_MILLAR)." ".$_SESSION['venta_forma_pago']; ?></small></h4>
                 <h4 class="subtitle is-5 has-text-centered has-text-weight-bold mb-5"><small>IVA: <?php echo MONEDA_SIMBOLO.number_format($_SESSION['venta_iva'],MONEDA_DECIMALES,MONEDA_SEPARADOR_DECIMAL,MONEDA_SEPARADOR_MILLAR)." ".$_SESSION['venta_forma_pago']; ?></small></h4>
                  <h4 class="subtitle is-5 has-text-centered has-text-weight-bold mb-5"><small>TOTAL A PAGAR: <?php echo MONEDA_SIMBOLO.number_format($_SESSION['venta_total'],MONEDA_DECIMALES,MONEDA_SEPARADOR_DECIMAL,MONEDA_SEPARADOR_MILLAR)." ".$_SESSION['venta_forma_pago']; ?></small></h4>
...
<script>
    ...
    function remover_cliente(id){
        ...
        Swal.fire({
            ...
            text: "Se va a cambiar la moneda en que se realizara la venta",
            icon: 'question',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
            ...
            if (result.isConfirmed){
                ...
                let datos = new FormData();
                datos.append("modulo_venta", "cambiar_forma");
