<?php
	...
	class saleController extends mainModel{
        ...
        public function removerClienteVentaControlador(){
         ...
         public function cambiarFormaControlador(){

			if($_SESSION['venta_forma_pago'] == "Bs"){
				$_SESSION['venta_forma_pago'] = 'USD';
			}else{
			...
			if(isset($_SESSION['venta_forma_pago'])){
				...
				$alerta=[
					"tipo"=>"simple",
					"titulo"=>"Ocurrió un error inesperado",
					"texto"=>"No hemos podido cambiar la forma de pago",
					"icono"=>"error"
				];	
			}
			return json_encode($alerta);
        ...
        public function registrarVentaControlador(){
			...
			$venta_subtotal=number_format($_SESSION['venta_subtotal'],MONEDA_DECIMALES,'.','');
			$venta_iva=number_format($_SESSION['venta_iva'],MONEDA_DECIMALES,'.','');
            $venta_fecha=date("Y-m-d");
            $venta_hora=date("h:i a");
            $venta_forma_pago=$_SESSION['venta_forma_pago'];
			...
			$datos_venta_reg=[
				...
				[
					"campo_nombre"=>"venta_subtotal",
					"campo_marcador"=>":Subtotal",
					"campo_valor"=>$venta_subtotal
				],
				[
					"campo_nombre"=>"venta_iva",
					"campo_marcador"=>":IVA",
					"campo_valor"=>$venta_iva
				],
				[
				...
				[
					...
					"campo_marcador"=>":venta_forma_pago",
					"campo_valor"=>$venta_forma_pago
				]
